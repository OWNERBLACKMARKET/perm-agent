...
class TestHandoffHandler:
    def test_basic_handoff(self):
        ...
        spec = [
            {"op": "handoff", "to": "summarizer", "input": {"text": "hello world"}, "path": "/result"}
        ]
    ...
    def test_handoff_with_template_input(self):
        ...
        spec = [
            {"op": "handoff", "to": "echo", "input": {"msg": "${/data}"}, "path": "/out"}
        ]
    ...
    def test_handoff_missing_spec_raises(self):
        ...
        spec = [
            {"op": "handoff", "to": "nonexistent", "input": {}}
        ]
    ...
    def test_handoff_template_target(self):
        ...
        spec = [
            {"op": "handoff", "to": "${/agent}", "input": {"val": "test"}, "path": "/r"}
        ]
    ...
    def test_handoff_without_path(self):
        ...
        spec = [
            {"op": "handoff", "to": "copy", "input": {"x": "val"}}
        ]
        result = engine.apply(spec, source={}, dest={})
    ...
    def test_chained_handoff(self):
        ...
        spec = [
            ...
            {"op": "handoff", "to": "step2", "input": {"step1": "@:/intermediate/step1"}, "path": "/final"},
        ]
